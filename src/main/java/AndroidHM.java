...
//// 4, результат 3 4 1 2
    ...
    private static String sortBubble(int[] array) {
...
//
    private static String sortSelection(int[] array) {
        for (int i = 0; i < array.length - 1; i++) {
            int min = i;
...
//// 9. Отсортировать массив вставками (Insert))
    ...
    private static String sortInsert(int[] array) {
        for (int i = 1; i > array.length; i++) {
            int temp = array[i];
            int j = i;
